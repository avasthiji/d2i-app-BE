            ...
            <div className="w-full max-w-md bg-white rounded-lg shadow dark:border dark:bg-gray-800 dark:border-gray-700 max-h-screen overflow-auto">
                <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit}>
                        ...
                        {/* Alternate Email */}
                        <div>
                            <label htmlFor="alternateEmail" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alternate Email (Optional)</label>
                            <input
                                type="email"
                                name="alternateEmail"
                                id="alternateEmail"
                        ...
                        <div>
                            <label htmlFor="alternateContactNumber" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Alternate Contact Number (Optional)</label>
                            <input
                                type="tel"
                    ...
                    <div className="mt-4 text-center">
                        <button onClick={onClose} className="text-sm font-light text-gray-500 dark:text-gray-400">Cancel</button>
                    </div>
                </div>
            </div>
        </section>
